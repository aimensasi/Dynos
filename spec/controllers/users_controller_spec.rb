...
RSpec.describe UsersController, type: :controller do
  let(:valid_params) {{ first_name: "Josh",last_name: "Teng", email: "josh@na.com", password: "123456", password_confirmation: "123456"}}
  let(:invalid_params) {{ first_name: "Josh",last_name: "Teng", email: "joshna.com", password: "123456", password_confirmation: "123456"}}
  let(:valid_params_update) {{ first_name: "Josh",last_name: "Teng", email: "josh@nextacademy1.com", password: "123456", password_confirmation: "123456"}}
  let(:invalid_params_update) {{ first_name: "Josh",last_name: "Teng", email: "joshnextacademy1.com", password: "123456", password_confirmation: "123456"}}

  let(:user){User.create(valid_params)}
  let(:user1){User.create(first_name: "Audrey",last_name: "Teng", email:"audrey@na.com", password: "123456", password_confirmation: "123456")}
